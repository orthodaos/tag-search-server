...
import ru.slrscrt.util.AdvancedTableBuilder.Border
...
class AdvancedTableBuilder[T](
  ...
  import ru.slrscrt.util.AdvancedTableBuilder.{Margin, MaxTableLength, MinTableLength, TitleWrap}
  ...
  def defineLengthsAndLines(title: Option[String], s: String): (Int, Int, Array[String]) = {
...
object AdvancedTableBuilder {
  ...
  private val MinTableLength = 150

  private val MaxTableLength = 150
